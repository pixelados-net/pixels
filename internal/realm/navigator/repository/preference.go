...
type PreferenceParams struct {
	...
	Preference navmodel.Preference
}
...
type CategoryPreferenceParams struct {
	...
	Preference navmodel.CategoryPreference
}

// UpsertPreference saves navigator preferences.
func (repository *Repository) UpsertPreference(ctx context.Context, params PreferenceParams) (navmodel.Preference, error) {
...
func (repository *Repository) UpsertCategoryPreference(ctx context.Context, params CategoryPreferenceParams) (navmodel.CategoryPreference, error) {
	preference := params.Preference
