...
import (
	...
	"github.com/niflaot/pixels/internal/realm/room/control/moderation"
	"github.com/niflaot/pixels/pkg/postgres"
)

// Repository persists room moderation state.
...
// New creates a room moderation repository.
...
func (repository *Repository) WithinTransaction(ctx context.Context, work moderation.TransactionWork) error {
