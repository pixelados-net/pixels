...
overriding system value values
 (160,1,'demo','Rooms Finals Lab','Recorrido guiado: puertas, estados, pared, Lovelock, Mystery Box, rentable, stack helper y firework.','model_a',2,0,2,0,false)
...
insert into room_tags(room_id,tag) values (160,'qa-rooms-finals')
