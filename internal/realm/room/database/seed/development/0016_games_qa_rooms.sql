...
overriding system value values
 (150,1,'demo','Banzai Arena','Battle Banzai teams, tiles, puck, sphere and timer.','model_a',25,0,2,0,false),
 (151,1,'demo','Freeze Arena','Freeze teams, blocks, exits, power-ups and timer.','model_a',25,0,2,0,false),
 (152,1,'demo','Football Pitch','Football physics, directional goals and scoreboards.','model_a',25,0,2,0,false),
 (153,1,'demo','Tag and Polls','IceTag, Bunnyrun and the DB-backed poll lab.','model_a',25,0,2,0,false)
...
insert into room_tags(room_id,tag) values
 (150,'qa-games-banzai'),(151,'qa-games-freeze'),(152,'qa-games-football'),(153,'qa-games-tag-polls')
