...
values
    (110,1,'milo','WIRED QA Avatar','Stacks 1-2: enter message and keyword toggle.','model_a',25,0,2,0,true),
    (111,1,'milo','WIRED QA Timers','Periodic, random, unseen, delay, reset and call-stack fixtures.','model_a',25,0,2,0,true),
    (112,1,'milo','WIRED QA Movement','Walk, collision, selected furniture and movement effects.','model_a',25,0,2,0,true),
    (113,1,'milo','WIRED QA Game','Teams, blobs and classic/team/wins scoreboards.','model_a',25,0,2,0,true),
    (114,1,'milo','WIRED QA Bots','Bot speech, movement, follow, clothing and hand-item fixtures.','model_a',25,0,2,0,true),
    (115,1,'milo','WIRED QA Rewards','Atomic rewards, room moderation and trace-budget fixtures.','model_a',25,0,2,0,true)
