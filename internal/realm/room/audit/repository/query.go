...
func (repository *Repository) RightsHistory(ctx context.Context, query Query) ([]auditmodel.RightsAudit, error) {
...
func (repository *Repository) ModerationHistory(ctx context.Context, query Query) ([]auditmodel.ModerationAction, error) {
