// Package session resolves room command session context.
package session
...
var (
	...
	ErrBindingNotFound = errors.New("room session binding not found")

	// ErrPlayerNotFound reports a missing live player.
	ErrPlayerNotFound = errors.New("room live player not found")
)
