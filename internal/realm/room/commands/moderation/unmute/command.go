// Package unmute ends a player's active room mute.
package unmute
...
const (
	// Name identifies the room unmute command.
	Name command.Name = "room.moderation.unmute"
)

// Command unmutes one room occupant.
type Command struct {
...
// Handler handles room unmute commands.
type Handler struct {
