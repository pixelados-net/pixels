// Package mute mutes a player in the actor's current room.
package mute
...
const (
	// Name identifies the room mute command.
	Name command.Name = "room.moderation.mute"
)

// Command mutes one room occupant.
type Command struct {
...
// Handler handles room mute commands.
type Handler struct {
