// Package save persists editable room settings.
package save
...
import (
	...
	settingsupdated "github.com/niflaot/pixels/internal/realm/room/events/settingsupdated"
...
const (
	// Name identifies the room settings save command.
	Name command.Name = "room.settings.save"
)

// Command contains a complete client room settings mutation.
type Command struct {
...
// Handler handles room settings saves.
type Handler struct {
...
// RoomManager reads and updates room settings.
...
func (handler Handler) broadcast(ctx context.Context, active *roomlive.Room, room roommodel.Room) error {
...
func (handler Handler) sendError(ctx context.Context, connection netconn.Context, roomID int64, cause error) error {
