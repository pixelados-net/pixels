...
func (definition Definition) EmitsWalkEvents() bool {
	return definition.InteractionType == "gate" ||
		...
		strings.HasPrefix(definition.InteractionType, "battlebanzai_") ||
		strings.HasPrefix(definition.InteractionType, "freeze_") ||
		strings.HasPrefix(definition.InteractionType, "icetag_") ||
		strings.HasPrefix(definition.InteractionType, "rollerskate_") ||
		strings.HasPrefix(definition.InteractionType, "bunnyrun_") ||
		definition.InteractionType == "football_gate"
}
