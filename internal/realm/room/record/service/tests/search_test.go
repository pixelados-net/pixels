...
func (store *fakeStore) CreateRoom(context.Context, roomservice.CreateRecordParams) (roommodel.Room, error) {
	return roommodel.Room{}, nil
}

// UpdateRoom updates a room for tests.
func (store *fakeStore) UpdateRoom(context.Context, roomservice.UpdateRecordParams, []string) (roommodel.Room, bool, error) {
