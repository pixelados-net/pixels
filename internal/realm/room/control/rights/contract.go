...
// PlayerRoomStore reads room identifiers where a player holds explicit rights.
type PlayerRoomStore interface {
	// ListRoomIDsByPlayer lists active room identifiers for one rights holder.
	ListRoomIDsByPlayer(context.Context, int64) ([]int64, error)
}
