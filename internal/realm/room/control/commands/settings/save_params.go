...
func updateParams(input SaveCommand, allowReserved bool) roomservice.UpdateParams {
...
func clubFieldsChanged(room roommodel.Room, input SaveCommand) bool {
...
func clubFieldsAllowed(room roommodel.Room, input SaveCommand, hasClub bool, globalManager bool) bool {
...
func moderationFieldsChanged(room roommodel.Room, input SaveCommand) bool {
