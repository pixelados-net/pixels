...
func translationKey(err error) (i18n.Key, bool) {
	switch {
	case errors.Is(err, roomrights.ErrAccessDenied), errors.Is(err, roommoderation.ErrAccessDenied):
	...
	case errors.Is(err, roommoderation.ErrInvalidMuteDuration), errors.Is(err, roommoderation.ErrInvalidBanDuration), errors.Is(err, roomrights.ErrInvalidIdentity), errors.Is(err, roomcommand.ErrTargetNotInRoom):
