// Package request adapts the room settings request packet.
package request
...
import (
	...
	requestcmd "github.com/niflaot/pixels/internal/realm/room/commands/settings/request"
...
// New creates a room settings request packet handler.
...
// Register adds the room settings request handler.
