...
--validCheckSum: 9:1abdf97d2984df974c9cc76ca94483c0
insert into player_badges(player_id,code,equipped,source)
select id,'ACH_WiredQA1',false,'seed'
from players where lower(username) in ('demo','alice')
...
select id,0 from players where lower(username) in ('demo','alice','bob','carol')
