// Package authenticating contains the player authenticating event.
...
// Name identifies the player authenticating event.
const Name bus.Name = "player.authenticating"
