...
func definitionValuesForTest() []any {
	...
	return []any{
		int64(2), 39, "chair_plasto", "chair_plasto", "A plain plastic chair.", "floor", 1, 1, 1.0,
		false, false, true, false, true, true, true, true, int32(0), []int32{101, 102}, pgtype.Int4{}, pgtype.Int4{},
		"default", 2, "", "",
...
func itemValuesForTest(roomID pgtype.Int8, x pgtype.Int2, y pgtype.Int2, z pgtype.Float8) []any {
	...
	return []any{
		...
		pgtype.Text{}, "0", pgtype.Int8{}, pgtype.Timestamptz{}, pgtype.Int4{}, pgtype.Int4{}, pgtype.Int4{}, false, false, pgtype.Int4{}, pgtype.Int4{}, pgtype.Int4{}, pgtype.Int8{}, pgtype.Text{}, []byte(`{}`),
		now, now, pgtype.Timestamptz{}, int64(1),
	}
}
