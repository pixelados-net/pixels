...
// TestFindDefinitionByIDWrapsError verifies definition lookup error propagation.
func TestFindDefinitionByIDWrapsError(t *testing.T) {
...
// TestListDefinitionsWrapsRowsError verifies definition list error propagation.
func TestListDefinitionsWrapsRowsError(t *testing.T) {
