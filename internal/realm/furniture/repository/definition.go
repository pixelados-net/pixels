...
const (
	...
	definitionColumns = `id, sprite_id, name, public_name, description, kind, width, length, stack_height::float8, allow_stack, allow_walk, allow_sit, allow_lay, allow_inventory_stack, allow_trade, allow_marketplace_sale, allow_recycle, redeemable_credits, effect_pool, effect_male, effect_female, interaction_type, interaction_modes_count, multiheight, custom_params, metadata, created_at, updated_at, deleted_at, version`
