...
func (repository *Repository) UpdateItemStackHeight(ctx context.Context, itemID int64, roomID int64, heightCM *int32) (furnituremodel.Item, bool, error) {
	return repository.queryItem(ctx, updateItemStackHeightSQL, itemID, roomID, heightCM)
}
