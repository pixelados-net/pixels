...
values
    ...
    -- Stack: enter-room filtered to alice only.
...
values
    ...
    (426040,'[]','alice',0,0),(426041,'[]','PASS filtered entry for alice.',0,0),
    (426050,'[]','minutereward',0,0),(426051,'[3,1,0,1]','',0,0),
    (426060,'[]','',0,0),(426061,'[]','Extras lab: ride the roller onto the plate, cross the carpet, re-enter as alice, say minutereward.',0,0)
