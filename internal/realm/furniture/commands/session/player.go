// Package session resolves furniture command session context.
package session
...
var (
	...
	ErrBindingNotFound = errors.New("furniture session binding not found")

	// ErrPlayerNotFound reports a missing live player.
	ErrPlayerNotFound = errors.New("furniture live player not found")
)
