...
func TestBubbleErrorKeyMapsKnownErrors(t *testing.T) {
	cases := []struct {
		...
		{roomlive.ErrInvalidPlacement, "invalid_move", true},
		{roomfurniture.ErrInvalidTarget, "invalid_move", true},
		{furnitureservice.ErrInvalidPlacement, "invalid_move", true},
		{furnitureservice.ErrInvalidItemID, "invalid_move", true},
		{furnitureservice.ErrInvalidRoomID, "invalid_move", true},
		{furnitureservice.ErrInvalidPlayerID, "invalid_move", true},
		{roomlive.ErrTileOccupied, "tile_has_units", true},
		{roomlive.ErrCannotStack, "cant_stack", true},
		{furnitureservice.ErrNotItemOwner, "no_rights", true},
		{furnitureservice.ErrItemNotInInventory, "item_not_in_inventory", true},
		{furnitureservice.ErrItemNotFound, "item_not_found", true},
		{furnitureservice.ErrItemNotPlaced, "item_not_found", true},
		{roomfurniture.ErrDefinitionNotFound, "item_not_found", true},
