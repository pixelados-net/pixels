...
insert into crafting_recipes(id,altar_definition_id,name,reward_definition_id,secret,limited,remaining,achievement_code,enabled) overriding system value values
 (920001,8388,'demo_recipe_normal',4,false,false,null,'Atcg',true),
 (920002,8388,'demo_recipe_limited',5,false,true,1,'Atcg',true),
 (920003,8388,'demo_recipe_secret',3,true,false,null,'AtcgSecret',true)
