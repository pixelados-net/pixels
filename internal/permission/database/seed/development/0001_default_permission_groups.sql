...
--changeset pixels:pixels-permission-seed-development-0001-default-groups context:development
...
--rollback delete from permission_player_groups where group_id in (1, 2);
