...
// TestEncode verifies AVAILABILITY_STATUS packet construction.
func TestEncode(t *testing.T) {
	packet, err := Encode(true, true)
	if err != nil {
...
// TestEncodeWithOptions verifies optional AVAILABILITY_STATUS packet fields.
func TestEncodeWithOptions(t *testing.T) {
	packet, err := Encode(true, true, WithIsAuthentic(true))
	if err != nil {
		t.Fatalf("encode packet: %v", err)
	}
