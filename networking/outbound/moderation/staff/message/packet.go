...
var Definition = codec.Definition{
	codec.Named("title", codec.StringField),
	codec.Named("message", codec.StringField),
}

// Encode creates a moderation message packet.
func Encode(title string, message string) (codec.Packet, error) {
	return codec.NewPacket(Header, Definition, codec.String(title), codec.String(message))
}
