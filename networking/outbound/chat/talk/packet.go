// Package talk contains the UNIT_CHAT outbound packet.
package talk
...
// Definition describes a rendered room chat message.
...
// Encode creates a UNIT_CHAT packet without embedded URLs.
