// Package shout contains the UNIT_CHAT_SHOUT outbound packet.
package shout
...
// Definition describes a rendered room shout.
...
// Encode creates a UNIT_CHAT_SHOUT packet without embedded URLs.
