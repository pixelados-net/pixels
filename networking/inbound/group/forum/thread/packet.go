// Package thread contains one Nitro social-group inbound packet.
package thread

import "github.com/niflaot/pixels/networking/codec"

// Header identifies this Nitro packet.
const Header uint16 = 3900

// Payload contains the two protocol identifiers.
type Payload struct {
	// GroupID stores the first identifier.
	GroupID int64
	// ThreadID identifies the selected forum thread.
	ThreadID int64
}
...
func Decode(packet codec.Packet) (Payload, error) {
	...
	return Payload{GroupID: int64(values[0].Int32), ThreadID: int64(values[1].Int32)}, nil
}
