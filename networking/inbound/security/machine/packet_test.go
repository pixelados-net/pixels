...
// TestDecode verifies SECURITY_MACHINE payload unpacking.
func TestDecode(t *testing.T) {
	packet, err := codec.NewPacket(Header, Definition, codec.String("value"), codec.String("value"), codec.String("value"))
