...
type CatalogItemRequest struct {
	...
	DefinitionID int64 `json:"definitionId,omitempty" minimum:"0"`
	// RewardKind identifies furniture or pet reward semantics.
	RewardKind string `json:"rewardKind" enum:"furniture,pet" default:"furniture"`
	// PetTypeID identifies the species granted by a pet offer.
	PetTypeID *int32 `json:"petTypeId,omitempty" minimum:"0" maximum:"35"`
	// PetProductCode identifies Nitro's localized pet product data.
	PetProductCode string `json:"petProductCode,omitempty" example:"pet0"`
...
type CatalogItemPatchRequest struct {
	...
	RewardKind *string `json:"rewardKind,omitempty" enum:"furniture,pet"`
	// PetTypeID replaces the species granted by a pet offer.
	PetTypeID *int32 `json:"petTypeId,omitempty" minimum:"0" maximum:"35"`
	// ClearPetType removes the pet species association.
	ClearPetType bool `json:"clearPetType,omitempty"`
	// PetProductCode replaces Nitro's localized pet product data.
	PetProductCode *string `json:"petProductCode,omitempty" example:"pet0"`
...
type CatalogItemResponse struct {
	...
	// RewardKind identifies furniture or pet reward semantics.
	RewardKind string `json:"rewardKind" required:"true"`
