...
func New(log *zap.Logger, config config.AppConfig, info build.Info, sso *sso.Service, redisClient *redispkg.Client, players playerservice.AdminManager, websocket *ws.Adapter, rooms roomservice.Manager, layouts roomlayout.Manager, runtime *roomlive.Registry, roomEntry *roomentry.Service, navigator navservice.Manager, currencyAdmin currencyroutes.Dependencies, catalogAdmin catalogroutes.Dependencies) *fiber.App {
	return newApplication(log, config, info, sso, redisClient, players, websocket, rooms, layouts, runtime, roomEntry, navigator, currencyAdmin, catalogAdmin, permissionroutes.Dependencies{}, roomroutes.Dependencies{}, chatroutes.Dependencies{}, messengerroutes.Dependencies{}, subscriptionroutes.Dependencies{}, tradingroutes.Dependencies{})
}
...
func NewWithPermissions(log *zap.Logger, config config.AppConfig, info build.Info, sso *sso.Service, redisClient *redispkg.Client, players playerservice.AdminManager, websocket *ws.Adapter, rooms roomservice.Manager, layouts roomlayout.Manager, runtime *roomlive.Registry, roomEntry *roomentry.Service, navigator navservice.Manager, currencyAdmin currencyroutes.Dependencies, catalogAdmin catalogroutes.Dependencies, permissionAdmin permissionroutes.Dependencies, roomAdmin roomroutes.Dependencies, chatAdmin chatroutes.Dependencies, messengerAdmin messengerroutes.Dependencies, subscriptionAdmin subscriptionroutes.Dependencies, tradingAdmin tradingroutes.Dependencies) *fiber.App {
	return newApplication(log, config, info, sso, redisClient, players, websocket, rooms, layouts, runtime, roomEntry, navigator, currencyAdmin, catalogAdmin, permissionAdmin, roomAdmin, chatAdmin, messengerAdmin, subscriptionAdmin, tradingAdmin)
}
...
func newApplication(log *zap.Logger, config config.AppConfig, info build.Info, sso *sso.Service, redisClient *redispkg.Client, players playerservice.AdminManager, websocket *ws.Adapter, rooms roomservice.Manager, layouts roomlayout.Manager, runtime *roomlive.Registry, roomEntry *roomentry.Service, navigator navservice.Manager, currencyAdmin currencyroutes.Dependencies, catalogAdmin catalogroutes.Dependencies, permissionAdmin permissionroutes.Dependencies, roomAdmin roomroutes.Dependencies, chatAdmin chatroutes.Dependencies, messengerAdmin messengerroutes.Dependencies, subscriptionAdmin subscriptionroutes.Dependencies, tradingAdmin tradingroutes.Dependencies) *fiber.App {
	...
	registerPrivate(app, sso, redisClient, players, rooms, runtime, roomEntry, navigator, currencyAdmin, catalogAdmin, permissionAdmin, roomAdmin, chatAdmin, messengerAdmin, subscriptionAdmin, tradingAdmin)
